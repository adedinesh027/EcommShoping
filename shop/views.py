...
from .models import Products, Contact, Oraders, OrderUpdate
...
def checkout(request):
    if request.method=="POST":
        ...
        phone = request.POST.get('phone', '')
        order = Oraders(items_json=items_json, name=name, email=email, address=address, city=city,
